...
namespace WaveBasedMethodModel
{
    public class RealMatrix
    {
        ...
        /// <param name="matrix">RealMatrix.</param>
        ...
        public static double[][] Inverse(double[][] matrix)
        {
            ...
            int n = matrix.Length;
            double[][] result = Copy(matrix); // make a copy of matrix
        ...
        /// <summary>
        /// Decompose the specified m into lum and perm.
        /// </summary>
        /// <returns>The decompose.</returns>
        /// <param name="m">M.</param>
        /// <param name="lum">Lum.</param>
        /// <param name="perm">Perm.</param>
        public static int Decompose(double[][] m, out double[][] lum, out int[] perm)
        {
            ...
            for (int j = 0; j < n - 1; ++j) // process by column. note n-1 
            {
                ...
                double xjj = lum[j][j];
                if (Math.Abs(xjj - 0.0) > double.Epsilon)
                {
                    for (int i = j + 1; i < n; ++i)
                    {
        ...
        /// <summary>
        /// Helper the specified luMatrix and b.
        /// </summary>
        /// <returns>The helper.</returns>
        /// <param name="luMatrix">Lu matrix.</param>
        ...
        /// <summary>
        /// Calculate the matrix's the determinant.
        /// </summary>
